...
def list_interviews(data, selected_file):
    ...
    print(f"Selected File: *{selected_file if selected_file else '<No selection>'}*")
    ...
    if selected_file:
        ...
        with open(selected_file, "r") as f:
            ...
            if len(all_null)>0:
                print(f"Questions with NULL references: {json.dumps(all_null, indent=4)}")
    return option_list
...
def render_interview(selected_interview, results_file, guide_question):   
    # print(selected_interview, results_file, question) 
    if selected_interview and results_file:
        transcript = []
            ...
            with open(results_file, "r") as f:
                ...
                if curr_interview:
                    question = next((item for item in curr_interview 
                            if item["guide_question"] == guide_question), None)
                else:
                    question = None
