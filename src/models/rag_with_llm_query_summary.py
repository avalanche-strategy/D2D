...
from src.utils.output_utils import generate_output_from_summarized_matches
...
def main(transcript_dir: str, guidelines_path: str, gpt_model: str, api_key: str, output_path: str):
    ...
    """
    print("Summarized pipeline started ...")
    ...
    for transcript_path in transcript_files:
        ...
        group_embeddings = summarize_embed_groups(groups, model, device, gpt_model, api_key)
...
if __name__ == "__main__":
    ...
    output_path = os.path.join(project_root, "results", "rag_with_llm_query_summary_output.csv")
