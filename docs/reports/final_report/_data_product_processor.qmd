...
The processor pipeline, ss shown in @fig-rag-pipeline, comprises three core components: the **Pre-processor**, the **Retriever**, and the **Generator**. These components work together to efficiently transform raw input data into meaningful, structured outputs aligned with the Dialogue2Data (D2D) project’s objectives.
